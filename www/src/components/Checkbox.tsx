...
type Props = VariantProps<typeof checkboxWrapper> &
    VariantProps<typeof checkmarkRounding>;
                ...
                <CheckIcon
                    ...
                    className={cn(
                        icon({
                            ...
                            indeterminate: !(isIndeterminate ?? indeterminate),
                            disabled:
                                !(isIndeterminate ?? indeterminate) && disabled,
                        }),
                    )}
                    style={{
                        strokeDasharray: (() => {
                            if (!isMounted && !(isChecked ?? checked))
                                return 9999;
                ...
                <MinusIcon
                    ...
                    style={{
                        ...
                        strokeDashoffset: (() => {
                            ...
                            return (isIndeterminate ?? indeterminate)
                                ? 0
                                : indeterminateStrokeDashCount;
                        })(),
                    }}
                />
            </div>
