...
const subtext = cva([
    'flex flex-row items-center gap-2.5',
    'font-normal text-sm text-black/50 dark:text-white/50',
]);

const H = (classes: typeof heading1) =>
    React.forwardRef<HTMLHeadingElement, HProps>(function H(
 ...
 */
const P = React.forwardRef<HTMLParagraphElement, PProps>(function P(
    { children, className, ...props },
    ref,
) {
    ...
    return (
        <p
            ref={ref}
            role="separator"
            className={cn(paragraphClass, className)}
            {...props}>
            {children}
        </p>
    );
...
const Blockquote = React.forwardRef<HTMLQuoteElement, BlockquoteProps>(
    function Blockquote({ children, className, ...props }, ref) {
        ...
        return (
            <blockquote
                ref={ref}
                role="separator"
                className={cn(blockquoteClass, className)}
                {...props}>
                {children}
            </blockquote>
        );
 ...
 */
const Subtext = React.forwardRef<HTMLSpanElement, SubtextProps>(
    function Subtext({ children, className, ...props }, ref) {
        ...
        return (
            <span
                ref={ref}
                role="separator"
                className={cn(subtextClass, className)}
                {...props}>
                {children}
            </span>
        );
