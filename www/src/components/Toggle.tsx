...
type Props = VariantProps<typeof toggleWrapper> &
    VariantProps<typeof toggleRounding>;
...
const toggleWrapper = cva(
    ['relative select-none transition-all ease-out duration-[150ms]'],
    {
        variants: {
            /**
