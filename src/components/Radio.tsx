...
type Props = VariantProps<typeof radioWrapper> & VariantProps<typeof radioDot> & VariantProps<typeof radioRounding>;
interface RadioProps extends Omit<InputHTMLAttributes<HTMLInputElement>, 'size'>, Props {
    /**
...
const Radio = React.forwardRef<HTMLInputElement, RadioProps>(function Radio(
    ...
    const [isChecked, setIsChecked] = React.useState<boolean | undefined>(false);
    ...
    return (
        ...
        >
            <input
                ...
                {...props}
            />
            <div aria-hidden="true" className={cn(radioDotClass, roundingClass)}></div>
        </div>
    );
});
