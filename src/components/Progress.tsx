...
interface ProgressProps extends ProgressHTMLAttributes<HTMLProgressElement>, Props {
    /**
...
const progressBar = cva(['rounded-full transition-all ease-out duration-[150ms]'], {
    variants: {
        /**
         * @description The appearance of the progress bar.
         * @default 'normal'
 ...
 */
const Progress = React.forwardRef<HTMLProgressElement, ProgressProps>(function Progress(
    { className, appearance, size, rounding, disabled, value, max, ...props },
    ref,
) {
