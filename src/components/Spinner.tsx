...
const spinner = cva(['dark:invert transition-all ease-out duration-[150ms] animate-spin']);
 ...
 */
const Spinner = React.forwardRef<SVGSVGElement, SVGSpinnerProps>(function Spinner(
        ...
        >
            <g>
                <path
                    ...
                    stroke="currentColor"
                    strokeOpacity="0.25"
                    strokeWidth={+(strokeWidth ?? -0.00866 * size + 5.437) / 2}
                />
                <path d="M94 50A1 1 0 1 1 6 50" stroke="url(#spinnerpaint0)" />
                <path d="M94 50A1 1 0 1 0 6 50" stroke="url(#spinnerpaint1)" />
            </g>
            <defs>
                <linearGradient id="spinnerpaint0">
                    <stop stopColor="currentColor" />
                    <stop stopOpacity="0.5" stopColor="currentColor" offset="1" />
                </linearGradient>
